...
function build() {
  ...
  `pwd`/node_modules/.bin/webpack --config ./component-webpack.config.js --colors --entry ./node_modules/$1/demo/EXPLORER.js --output-path $outputPath --display-error-details
